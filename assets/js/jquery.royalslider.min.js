...
(function (k) {
	function u(b, e) {
		...
		for (var d = document.createElement("div").style, i = ["webkit", "Moz", "ms", "O"], h = "", j = 0, m, c = 0; c < i.length; c++)
			m = i[c], !h && m + "Transform" in d && (h = m), m = m.toLowerCase(), window.requestAnimationFrame || (window.requestAnimationFrame = window[m + "RequestAnimationFrame"], window.cancelAnimationFrame = window[m + "CancelAnimationFrame"] || window[m + "CancelRequestAnimationFrame"]);
		...
		if (a.st.allowCSS3 && (!f || a.st.allowCSS3OnWebkit))
			c = h + (h ? "T" : "t"), a._c = c + "ransform" in d && c + "ransition" in d, a._c && (a._d = h +
		...
		for (c = 0; c < a.numSlides; c++)
			a.slidesJQ.push(k('<div style="' + (a._j ? "" : c !== a.currSlideId ? "z-index: 0; display:none; opacity: 0; position: absolute;  left: 0; top: 0;" : "z-index: 0;  position: absolute; left: 0; top: 0;") + '" class="rsSlide "></div>'));
		...
		a.st.arrowsNav && (g = a.st.controlsInside ? a._a1 : a.slider, k('<div class="rsArrow rsArrowLeft"><div class="rsArrowIcn"></div></div><div class="rsArrow rsArrowRight"><div class="rsArrowIcn"></div></div>').appendTo(g), a._w1 = g.children(".rsArrowLeft").click(function (b) {
			...
			!a.hasTouch && (a._w1.addClass("rsHidden"), a._x1.addClass("rsHidden"), g.one("mousemove.arrowshover", function () {
		...
		a._b1.click(function (b) {
			if (!a.dragSuccess) {
				...
				if (-1 !== k.inArray(c, r) && a.toggleVideo())
					return !1;
				if (a.st.navigateByClick && !a._c2) {
					if (k(b.target).closest(".rsNoDrag", a._d1).length)
						return !0;
					a._d2(b)
				}
	...
	u.prototype = {
		...
		_p : function () {
			...
			if (this._v = this.st.loop)
				2 === this.numSlides ? (this._v = !1, this.st.loopRewind = !0) : 2 > this.numSlides && (this.st.loopRewind = this._v = !1);
		...
		_i2 : function (b, e) {
			function c(c, e, f) {
				c.isAdded ? (g(e, c), a(e, c)) : (f || (f = d.slidesJQ[e]), c.holder ? f = c.holder : (f = d.slidesJQ[e] = k(f), c.holder = f), c.appendOnLoaded = !1, a(e, c, f), g(e, c), d._k2(c, f, b), appended = c.isAdded = !0)
			}
			function g(a, c) {
			...
			if (s)
				for (h = l; h < l + n + 1; h++)
					q = f(h), r = Math.floor((d._q - (l - h)) / d.numSlides) * d.numSlides, (i = d.slides[q]) && c(i, q);
			if (t)
				for (h = l - 1; h > l - 1 - n; h--)
					q = f(h), r = Math.floor((d._q - (l - h)) / m) * m, (i = d.slides[q]) && c(i, q);
			if (!b) {
				p = f(l - n);
				l = f(l + n);
				n = p > l ? 0 : p;
				for (h = 0; h < m; h++)
					if (!(p > l && h > p - 1) && (h < n || h > l))
						if ((i = d.slides[h]) && i.holder)
							i.holder.detach(), i.isAdded = !1
			}
		},
		setItemHtml : function (b, e) {
				...
				return function (d) {
					...
					if (d) {
						...
						if ("error" === d.type) {
							...
							g.ev.trigger("rsAfterContentSet",
								a);
							return
						}
					}
					...
					i = a.id - g._l;
					!e && !a.appendOnLoaded && g.st.fadeinLoadedSlide && (0 === i || (g._m2 || g._g2) && (-1 === i || 1 === i)) ? (f.css(g._e + "transition", "opacity 400ms ease-in-out").css({
							visibility : "visible",
							opacity : 0
						}), h.html(f), setTimeout(function () {
							f.css("opacity", 1)
						}, 6)) : h.html(f);
					a.isRendered = !0;
			...
			if (b.isLoaded)
				...
				if (b.isLoading) {
					...
					var h = k("<img/>"),
					j = b.image;
					e ? c() : b.isLoading || (j || (j = h.attr("src"), h = k("<img/>")), b.holder.html(g._c1.clone()), b.isLoading =
							!0, b.imageLoader = h, h.one("load error", f(b)).attr("src", j))
				}
			else
				f(b)()
		},
		_k2 : function (b, e, c) {
			var g = b.holder,
			a = b.id - this._l;
			this._j && !c && this.st.fadeinLoadedSlide && (0 === a || (this._m2 || this._g2) && (-1 === a || 1 === a)) ? (e = b.content, e.css(this._e + "transition", "opacity 400ms ease-in-out").css({
					visibility : "visible",
					opacity : 0
				}), this._b1.append(g), setTimeout(function () {
					e.css("opacity", 1)
				}, 6)) : this._b1.append(g);
			b.appendOnLoaded = !1
		},
		_b2 : function (b, e) {
			...
			g;
			c.dragSuccess = !1;
			if (k(b.target).closest(".rsNoDrag",
					c._d1).length)
				return !0;
			e || c._m2 && c._n2();
			if (c._g2)
				...
				if (c.hasTouch) {
					...
					if (a && 0 < a.length)
						g = a[0], 1 < a.length && (c._o2 = !0);
					else
						return
				} else
					g = b, b.preventDefault();
				c._g2 = !0;
		...
		_d3 : function (b, e) {
			if (this._e3) {
				...
				g = i ? g : a;
				e ? f > this._g3 ? f = this._a3 + g * this._j1 : f < this._h3 && (f = this._a3 + g * this._j1) : this._v || (0 >= this.currSlideId && 0 < d - this._w2 && (f = this._a3 + g * this._j1), this.currSlideId >= this.numSlides - 1 && 0 >
		...
		_q2 : function (b, e) {
			...
			if (c.hasTouch) {
				...
				point = b;
			c._t2 || (c._c && (!e ? c._b1 : c._l3).css(c._e + c._o1, "0s"), function d() {
				c._g2 && (c._m3 = requestAnimationFrame(d), c._n3 && c._d3(c._n3, e))
			}
				());
			if (c._e3)
				b.preventDefault(), c._f3 = (new Date).getTime(), c._n3 = point;
			else {
				var g = !e ?
					c._f : c._x2,
		...
		_r2 : function (b, e) {
			...
			function g(b, d) {
				if (a._j || e)
					i = (-a._q - a._z) * a._s, h = Math.abs(a._m - i), a._b = h / d, b && (a._b += 250), a._b = c(a._b), a._q3(i, !1)
			}
			var a =
				this,
			f,
			...
			if (!a._t2 && !a._o2 && e && a._p3) {
				...
				if (0 === s || 1 >= p)
					...
					if (e) {
						...
						r + m < l ? 0 > s ? g(!1, d) : a._h2("prev", c(Math.abs(a._m - (-a._q - a._z + 1) * a._s) / d), !1, !0, !0) : r - m > l ? 0 < s ? g(!1, d) : a._h2("next", c(Math.abs(a._m - (-a._q - a._z - 1) * a._s) / d), !1, !0, !0) : g(!1, d)
				}
			}
		},
		_i3 : function (b) {
		...
		updateSliderSize : function (b) {
			var e,
			c;
			this.st.beforeResize &&
			this.st.beforeResize.call(this);
			if (this.st.autoScaleSlider) {
				var g = this.st.autoScaleSliderWidth,
				a = this.st.autoScaleSliderHeight;
				this.st.autoScaleHeight ? (e = this.slider.width(), e != this.width && (this.slider.css("height", e * (a / g)), e = this.slider.width()), c = this.slider.height()) : (c = this.slider.height(), c != this.height && (this.slider.css("width", c * (g / a)), c = this.slider.height()), e = this.slider.width())
			} else
				e = this.slider.width(), c = this.slider.height();
			this._e2 = this.slider.offset();
			this._e2 = this._e2[this._g];
			if (b ||
				e != this.width || c != this.height) {
				this.width = e;
				this.height = c;
				this._u3 = e;
				this._v3 = c;
				...
				for (e = 0; e < this.slides.length; e++)
					b = this.slides[e], b.positionSet = !1, b && (b.image && b.isLoaded) && (b.isRendered = !1, this._l2(b));
				if (this._x3)
					for (e = 0; e < this._x3.length; e++)
						b = this._x3[e], b.holder.css(this._g, (b.id + this._z) * this._s);
				this._i2();
				this._j && (this._c &&
					this._b1.css(this._e + "transition-duration", "0s"), this._i3((-this._q - this._z) * this._s));
		...
		removeSlide : function (b) {
			var e = this.slides[b];
			e && (e.holder && e.holder.remove(), b < this.currSlideId && this.currSlideId++, this.slides.splice(b, 1), this.slidesJQ.splice(b, 1), this.ev.trigger("rsOnRemoveSlide", [b]), this._z3(b), b === this.currSlideId && this.ev.trigger("rsAfterSlideChange"))
		},
		_z3 : function () {
			var b = this,
			e = b.numSlides,
		...
		_h2 : function (b, e, c,
			...
			if (i > h + 2) {
				f._z += (i - (h + 2)) * (j ? -1 : 1);
				e *= 1.4;
				for (h = 0; h < f.numSlides; h++)
					f.slides[h].positionSet = !1
			}
			f._b = e;
			f._i2(!0);
			a || (m = !0);
			...
			}, 0) : (f._q3(d, b, !1, c), f.ev.trigger("rsOnUpdateNav"))
		},
		_z1 : function () {
			this.st.arrowsNav &&
			(1 >= this.numSlides ? (this._w1.css("display", "none"), this._x1.css("display", "none")) : (this._w1.css("display", "block"), this._x1.css("display", "block"), !this._v && !this.st.loopRewind && (0 === this.currSlideId ? this._w1.addClass("rsArrowDisabled") : this._w1.removeClass("rsArrowDisabled"), this.currSlideId === this.numSlides - 1 ? this._x1.addClass("rsArrowDisabled") : this._x1.removeClass("rsArrowDisabled"))))
		},
		_q3 : function (b, e, c, g, a) {
			function f() {
				var a;
				if (i && (a = i.data("rsTimeout")))
					i !== h && i.css({
						opacity : 0,
						display : "none",
						zIndex : 0
					}), clearTimeout(a), i.data("rsTimeout", "");
			...
			d._c ? d._j ? (j[d._e + d._o1] = d._b + "ms", j[d._e + d._p1] = g ? k.rsCSS3Easing[d.st.easeInOut] : k.rsCSS3Easing[d.st.easeOut], d._b1.css(j), setTimeout(function () {
					d._i3(b)
				}, d.hasTouch ? 5 : 0)) : (d._b = d.st.transitionSpeed, i = d._a4, h = d._d1, h.data("rsTimeout") && h.css("opacity",
					0), f(), i && i.data("rsTimeout", setTimeout(function () {
						j[d._e + d._o1] = "0ms";
						j.zIndex = 0;
						j.display = "none";
						i.data("rsTimeout", "");
					...
					}, d._b + 60)), j.display = "block", j.zIndex = d._k, j.opacity = 0, j[d._e + d._o1] = "0ms", j[d._e + d._p1] = k.rsCSS3Easing[d.st.easeInOut], h.css(j), h.data("rsTimeout", setTimeout(function () {
						h.css(d._e + d._o1, d._b + "ms");
						h.data("rsTimeout", setTimeout(function () {
								h.css("opacity", 1);
								h.data("rsTimeout", "")
							}, 20))
					}, 20))) : d._j ? (j[d._f ? d._r1 : d._q1] = b + "px",
				d._b1.animate(j, d._b, g ? d.st.easeInOut : d.st.easeOut)) : (i = d._a4, h = d._d1, h.stop(!0, !0).css({
					opacity : 0,
					display : "block",
					zIndex : d._k
				}), d._b = d.st.transitionSpeed, h.animate({
					opacity : 1
				}, d._b, d.st.easeInOut), f(), i && i.data("rsTimeout", setTimeout(function () {
						i.stop(!0, !0).css({
							opacity : 0,
							display : "none",
							zIndex : 0
		...
		_n2 : function () {
			...
			if (this._j)
				if (this._c) {
					...
					this._b1.stop(!0), this._m = parseInt(this._b1.css(this._r1), 10);
			else
				20 < this._k ? this._k = 10 : this._k++
		},
		_g4 : function () {
		...
		_h4 : function (b, e) {
			return this._c ?
			this._s1 + (e ? b + this._t1 + 0 : 0 + this._t1 + b) + this._u1 : b
		},
		_f4 : function () {
		...
		_e4 : function (b, e) {
			...
			if (0 !== c.numSlides)
				if (c.st.loopRewind)
					"left" === b ? c.goTo(c.numSlides - 1, e) : c.goTo(0, e);
		...
		_l2 : function (b) {
			if (!b.isRendered) {
				...
				d;
				b.videoURL && (c = "rsVideoContainer", "fill" !== f ? g = !0 : (d = e, d.hasClass(c) || (d = d.find("." + c)), d.css({
								width : "100%",
								height : "100%"
							}), c = "rsImg"));
				...
				if ("none" !== f || a) {
					...
					j,
					k = {};
					if ("fit-if-smaller" === f && (i > b || c > d))
						f = "fit";
					if ("fill" === f || "fit" === f)
						h = b / i, j = d / c, h = "fill" == f ? h > j ? h : j : "fit" == f ? h < j ? h : j : 1, i = Math.ceil(i * h, 10), c = Math.ceil(c * h, 10);
					"none" !== f && (k.width = i, k.height = c, g && e.find(".rsImg").css({
							width : "100%",
							height : "100%"
						}));
		...
		_f5 : function () {
			...
			"bullets" === a.st.controlNavigation && (a.ev.one("rsAfterPropsSetup", function () {
					...
					for (var b = '<div class="rsNav rsBullets">', e = 0; e < a.numSlides; e++)
						b += '<div class="rsNavItem rsBullet"><span class=""></span></div>';
					b = c(b + "</div>");
					a._t4 = b;
					a._h5 = b.children();
					a.slider.append(b);
...
(function (f) {
	f.extend(f.rsProto, {
		...
		_a6 : function () {
			...
			for (var h = 0; h < a.numSlides; h++)
				g = a.slides[h], b += "<div" + c + ' class="rsNavItem rsThumb">' + a._e6 + g.thumbnail + "</div>";
			b = f(b + "</div></div>");
			a._l3 = f(b).find("." + e + "Container");
			a._h6 && (e += "Arrow", a.st.thumbs.arrowLeft ? a._i6 = a.st.thumbs.arrowLeft : (a._i6 = f('<div class="' + e + " " + e + 'Left"><div class="' + e + 'Icn"></div></div>'), b.append(a._i6)), a.st.thumbs.arrowRight ? a._j6 =
					a.st.thumbs.arrowRight : (a._j6 = f('<div class="' + e + " " + e + 'Right"><div class="' + e + 'Icn"></div></div>'), b.append(a._j6)), a._i6.click(function () {
					...
					a._t3(b < a._h3 ? a._h3 : b)
						...
						a._b6 &&
						(a._i6.css("opacity", 1), a._j6.css("opacity", 1))
					}, function () {
		...
		updateThumbsSize : function () {
			...
			if (a._r3 < a._s3)
				a.st.thumbs.autoCenter && a._j3((a._s3 - a._r3) / 2), a.st.thumbs.arrows && a._i6 && (a._i6.addClass("rsThumbsArrowDisabled"), a._j6.addClass("rsThumbsArrowDisabled")), a._b6 = !1, a._g6 = !1,
				a._t4.off(a._f1);
			else if (a.st.thumbs.navigation && !a._b6 && (a._b6 = !0, !a.hasTouch && a.st.thumbs.drag || a.hasTouch && a.st.thumbs.touch))
				a._g6 = !0, a._t4.on(a._f1, function (b) {
					a._b2(b, !0)
				});
			a._l3.css(b);
			if (a._p3 && (a.isFullscreen || a.st.thumbs.fitInViewport))
				a._x2 ? a._v3 = a._n6 - a._t4.outerHeight() : a._u3 = a._n6 - a._t4.outerWidth()
		},
...
(function (e) {
	e.extend(e.rsProto, {
		...
		_x5 : function () {
			...
			for (var b = 0; b < a.numSlides; b++)
				b === a.numSlides - 1 && (style = ""), d = a.slides[b], c += '<div class="rsNavItem rsTab">' + d.thumbnail + "</div>";
			c = e(c + "</div>");
			a._t4 = c;
	...
	e.extend(e.rsProto, {
		...
		playVideo : function () {
			...
			if (!a._d4) {
				...
				f,
				d;
				c.match(/youtu\.be/i) || c.match(/youtube\.com\/watch/i) ? (d = /^.*((youtu.be\/)|(v\/)|(\/u\/\w\/)|(embed\/)|(watch\?))\??v?=?([^#\&\?]*).*/, (d = c.match(d)) && 11 == d[7].length && (f = d[7]), void 0 !== f && (a._s6 = a.st.video.youTubeCode.replace("%id%", f))) : c.match(/vimeo\.com/i) && (d = /\/\/(www\.)?vimeo.com\/(\d+)($|\/)/,
					(d = c.match(d)) && (f = d[2]), void 0 !== f && (a._s6 = a.st.video.vimeoCode.replace("%id%", f)));
				a.videoObj = e(a._s6);
		...
		_k4 : function () {
			function j() {
				...
				if (a.currSlide && a.currSlide.isLoaded && a._o4 !== e) {
					if (0 < a._n4.length) {
						for (b = 0; b < a._n4.length; b++)
							clearTimeout(a._n4[b]);
						a._n4 = []
					}
					if (0 < a._m4.length) {
						var g;
						for (b = 0; b < a._m4.length; b++)
							if (g = a._m4[b])
								a._c ? (g.block.css(a._e + a._o1, "0s"), g.block.css(g.css)) : g.running ? g.block.stop(!0, !0) : g.block.css(g.css), a._o4 = null, e.animBlocksDisplayed = !1;
						a._m4 = []
					}
		...
		_r4 : function () {
			...
			if (a.st.autoHeight) {
				...
				var d = function (f) {
					...
					b = e.holder;
					if (e.isLoaded)
						b && (c = b.height(), 0 !== c && void 0 !== c && (a._v3 = c, a._c || !f ? a._a1.css("height", c) : a._a1.stop(!0, !0).animate({
									height : c
...
(function (a, b, g) {
	...
	var n = function () {
		var c = d(),
		e = q(m);
		c !== m ? (p(m = c, e), a(b).trigger("hashchange")) :
		e !== m && (location.href = location.href.replace(/#.*/, "") + e);
